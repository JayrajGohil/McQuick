...
#ifndef MCQUICK_SWIFT_H
#define MCQUICK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="mcquick",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7mcquick11AppDelegate")
...
SWIFT_CLASS("_TtC7mcquick13SceneDelegate")
...
SWIFT_CLASS("_TtC7mcquick14ViewController")
